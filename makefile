...
_DEPS = ball_plate.h manual_mode.h micro_maestro.h playsound.h wiimote_stuff.h touchscreen.h pid.h
DEPS = $(patsubst %,$(IDIR)/%,$(_DEPS))

_OBJ = ball_plate.o manual_mode.o micro_maestro.o playsound.o wiimote_stuff.o touchscreen.o pid.o
